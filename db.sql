--! TABELA ORYGINALNA - ZACHOWANE ZMIENNE OBJECT I ARRAY !--
...
CREATE TABLE ordercreatedata (
    ...
    product.order_id int NOT NULL,
    product.product_id int NOT NULL,
    product.stock_id int NOT NULL,
    product.price double NOT NULL,
    product.discount_perc double NOT NULL,
    product.quantity float NOT NULL,
    product.delivery_time float NOT NULL,
    product.name text NOT NULL,
    product.code text NOT NULL,
    product.pkwiu text NOT NULL,
    product.tax text NOT NULL,
    product.tax_value int NOT NULL,
    product.unit text NOT NULL,
    product.option text NOT NULL,
    product.unit_fp boolean NOT NULL,
    product.weight double NOT NULL,
    additional_fields array NOT NULL,
    additional_fields.field_id int NOT NULL,
    additional_fields.type int NOT NULL,
    additional_fields.locate int NOT NULL,
    additional_fields.req boolean NOT NULL,
    additional_fields.active boolean NOT NULL,
    additional_fields.order int NOT NULL,
    additional_fields.value text NOT NULL   )